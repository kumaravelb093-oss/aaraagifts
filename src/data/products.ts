...
export const allProducts: Product[] = [
    ...
    },
    {
        ...
        description: "Elegant orange-and-gold favor boxes adorned with intricate paisley prints and custom cartoon couple illustrations. A premium way to present sweets, dry fruits, or small tokens of gratitude.",
...

    {
        ...
        description: "A vibrant 5-piece polo set in sky blue, tangerine orange, deep orange, classic black, and royal blue. Crafted from breathable piqué cotton, ideal for team branding and corporate events.",
    ...
    },
    {
        ...
        description: "A comprehensive 6-shade polo collection featuring sky blue, navy, silver grey, jet black, deep orange, and electric royal blue. Premium cotton piqué fabric covers every institutional color requirement.",
    ...
    },
    {
        ...
        description: "An expertly curated assortment of six premium polo shirts in a harmonious palette. From cool blues to warm oranges, each shirt features a classic collar, reinforced stitching, and comfortable regular fit.",
